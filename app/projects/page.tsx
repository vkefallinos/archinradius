  ...
  return (
    <div className="flex justify-between items-center bg-white p-2">
      ...
      <div className="flex items-center">
        <button className="border-2 border-gray-300 p-1 px-2" onClick={()=>setShowFilters(!showFilters)}>FILTERS</button>
...
const ListItem: React.FC<ListItemProps> = ({ title, subtitle, imageSrc }) => {
  return (
    <div className="border-b border-gray-300 p-4 flex">
      <img className="h-20 w-20 object-cover mr-4" src={imageSrc} alt={title} />
      <div>
        <div className="font-bold">{title}</div>
        <div className="text-xs mb-2">{subtitle}</div>
        <div className="text-gray-500 text-xs">vmc,xmvlmc,m,vm.c,mv,cmxv,...</div>
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="overflow-y-auto">
        <ListItem title="Housing Mets//Athens" subtitle="T. Zenetos" imageSrc="/path-to-image1.jpg" />
        <ListItem title="Xenia Hotel//Kalambaka" subtitle="A. Koutsiiiiidis" imageSrc="/path-to-image2.jpg" />
        <ListItem title="Xenia Hotel//Kalambaka" subtitle="A. Koutsiiiiidis" imageSrc="/path-to-image2.jpg" />
        <ListItem title="Xenia Hotel//Kalambaka" subtitle="A. Koutsiiiiidis" imageSrc="/path-to-image2.jpg" />
        <ListItem title="Xenia Hotel//Kalambaka" subtitle="A. Koutsiiiiidis" imageSrc="/path-to-image2.jpg" />
        <ListItem title="Xenia Hotel//Kalambaka" subtitle="A. Koutsiiiiidis" imageSrc="/path-to-image2.jpg" />
